const EmailModel = require('../../models/interf/emailInterferencia');
...
module.exports = {
    index: async (req, res) => {
        ...
        try{
            ...
            res.render('tecnica/interferencia/emails/index', {
                emails,
                currentPage: page,
    ...
    show: async(req, res) => {
        try{
            ...
            const solicitud = await EmailModel.getSolicitudById(email.solicitud_id);
            email.solicitud = solicitud || null;

            res.render('tecnica/interferencia/emails/show', {email});
        }catch (err){
